...
/**
 * DELETE /api/logistics-company/vehicles/[id] — retire one of the signed-in
 ...
 * letting a caller enumerate other companies' vehicles.
 *
...
export async function DELETE(
  ...
  // or for a vehicle owned by an independent driver.
