...
/**
 * The dashboard's fixed left rail: brand mark, the tab list, and the signed-in
 * company's identity at the foot. It owns no state — the active tab and the
 * change handler both come from `OpsDashboardShell`, which is the single owner
 * of tab state.
 */
